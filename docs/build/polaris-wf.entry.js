...
import { T as TypeKeys } from './app-93d25773.js';
...
const PolarisWf = class {
    ...
    render() {
        return (h("div", null, "Hello, my name is ", this.name, h("my-component", null)));
    }
};

export { PolarisWf as polaris_wf };
