...
const developmentOnly$1 = unwrapExports(developmentOnly);
...
const wf = (state = getInitialState$1(), action) => {
    switch (action.type) {
        case TypeKeys$1.SET_MODEL_VALUE:
            const model = merge(state.model, action.name, action.value);
            return Object.assign(Object.assign({}, state), { model: Object.assign({}, model) });
        case TypeKeys$1.SET_NEXT_ACTION:
            return Object.assign(Object.assign({}, state), { currAction: action.name });
        case TypeKeys$1.SET_PROCESS:
            return Object.assign(Object.assign({}, state), { currProcess: action.process, currAction: 'start' });
        default:
            return state;
    }
};
function merge(model, name, value) {
...
const configureStore = (preloadedState) => createStore(rootReducer, preloadedState, developmentOnly_1(applyMiddleware(thunk)));
...
class PageActivity {
    constructor() {
        ...
        this.execute = (context) => {
            ...
            setTimeout(() => context.container.page = Object.assign(Object.assign({}, this), { context: context }), 0);
        };
    }
    static create(act) {
...
class DesisionActivity extends CodeActivity {
    constructor() {
        super(...arguments);
        this.type = DesisionActivity.type;
        this.execute = (context) => {
...
DesisionActivity.type = "desision-activity";
...
const SiriusWf = class {
    ...
    render() {
        return h("sirius-page", { page: this.page });
    }
};

export { SiriusWf as sirius_wf };
